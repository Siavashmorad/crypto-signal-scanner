...
void main() {
  test('market signal keeps timeframe, entry, ATR and multiple targets', () {
    final now = DateTime(2026, 8, 19);
    final signal = MarketSignal(symbol: 'BTCUSDT', side: 'LONG', timeframe: '15m', entry: 100, stopLoss: 98, tp1: 102, tp2: 104, tp3: 106, atr: 1.33, confidence: 75, riskReward: 2, timestamp: now);
    expect(signal.symbol, 'BTCUSDT');
    expect(signal.timeframe, '15m');
